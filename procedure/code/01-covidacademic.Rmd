...
```{r}
pm1 <- rismedextract(records1_re)
pm2 <- rismedextract(records2_re)
pm3 <- rismedextract(records3_re)
pm4 <- rismedextract(records4_re)
pm5 <- rismedextract(records5_re)
```


```{r}
write.csv(pm1, here::here("data", "raw", "public", "replication", "search1rismed.csv"))
write.csv(pm2, here::here("data", "raw", "public", "replication", "search2rismed.csv"))
write.csv(pm3, here::here("data", "raw", "public", "replication", "search3rismed.csv"))
write.csv(pm4, here::here("data", "raw", "public", "replication", "search4rismed.csv"))
write.csv(pm5, here::here("data", "raw", "public", "replication", "search5rismed.csv"))

write.csv(df1, here:here("data", "raw", "public", "replication", "search1pubmedr.csv"))
write.csv(df2, here:here("data", "raw", "public", "replication", "search2pubmedr.csv"))
write.csv(df3, here:here("data", "raw", "public", "replication", "search3pubmedr.csv"))
write.csv(df4, here:here("data", "raw", "public", "replication", "search4pubmedr.csv"))
write.csv(df5, here:here("data", "raw", "public", "replication", "search5pubmedr.csv"))
```

-- Add information on running python script 
...
# load
M <- convert2df(here("data", "raw", "public", "repplication", "xxxxxxxx.bib"), dbsource = "scopus", format = "bibtex")
```
...
plot_list$MostProdCountries + scale_fill_startrek() + theme_bw() +
